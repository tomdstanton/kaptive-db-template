...
*A template repo for curating [Kaptive](https://github.com/klebgenomics/Kaptive/) databases and app for metadata formatting*
...
Please refer to the [documentation](https://klebgenomics.github.io/Kaptive/db/curation.html) for details on Kaptive database curation.

Use the [![App](https://img.shields.io/badge/Streamlit-%23FE4B4B.svg?logo=streamlit&logoColor=white)](https://kaptive-database-validator.streamlit.app/) to validate your database
and build the metadata file.
